...
public class Demo {
		public static void main(String[] args) {
			...
			System.out.println(Arrays.toString(bookService.filterBooksByAuthor(new Author(1, "Jon", "Johnson"), books)));
			System.out.println("Publisher filter");
			System.out.println(Arrays.toString(bookService.filterBooksByPublisher(new Publisher(1, "Publisher_1"), books)));
