package functional_programming.bifunction;
...
public class FunctionsDemo {
	...
	public static void main(String[] args) {
		...
		map.computeIfAbsent(5, FunctionsDemo::ConvertIntToString);
		...
		map.computeIfPresent(2, FunctionsDemo::CombineIntAndString);
