...
public class OptionalDemo {
	...
	private static void flatMapExample() {
		User person = new User("Erion", 1990);
	...
	private static void mapExample() {
		Optional<User> optional = Optional.of(new User("Erion", 1990));
	...
	private static void filterExample() {
		Optional<String> optional = Optional.of("Erion Ademi");
		System.out.println("filter() demo: " + optional
					.filter(fullName -> fullName.contains("Erioni"))
				.orElse("No required name found"));
		
		System.out.println("filter() demo: " + optional
				.filter(fullName -> fullName.contains("Joni"))
			.orElse("No required name found"));
	}
